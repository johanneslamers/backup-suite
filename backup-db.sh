...
then
    ...
    mysqlcheck -h${MYSQL_HOST} -P${MYSQL_PORT} -u${MYSQL_USER} -p${MYSQL_PASSWORD} ${MYSQL_DATABASE} --auto-repair --optimize
    ...
    do
        ...
        # repair and optimize database
        mysqlcheck -h${MYSQL_HOST} -P${MYSQL_PORT} -u${MYSQL_USER} -p${MYSQL_PASSWORD} ${DB} --auto-repair --optimize
